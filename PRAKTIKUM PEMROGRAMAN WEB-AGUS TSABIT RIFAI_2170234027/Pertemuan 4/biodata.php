...
<body>
    ...
    echo "<h1>BIODATA</h1>";
    echo "<table width='60%'>";
    echo "<tr><td class='atas' width='30%'>Nama :</td><td width='30%'><input type='text' name='name' value='Agus Tsabit Rifai'></td></tr>";
    echo "<tr><td class='atas'>NIM :</td><td><input type='text' name='name' value='2170234027'></td></tr>";
    ...
    echo "<tr><td class='atas'>Foto :</td><td><img src='Rifai4.jpg' width='200px'></img></td></tr>";
